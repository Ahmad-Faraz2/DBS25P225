...
namespace MidProjectDb
{
    public partial class FacultyProfileForm: Form
    {
        ...
        {
            if (!int.TryParse(txtFacultyId.Text.Trim(), out int facultyId))
            {
                MessageBox.Show("Please enter a valid Faculty ID.", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("Error updating faculty profile.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure you want to delete this faculty profile?", "Confirm Deletion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                bool result = facultyService.DeleteFaculty(facultyId);
                if (result)
                {
                    MessageBox.Show("Faculty profile deleted successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ClearFields();
                }
                else
                {
                    MessageBox.Show("Error deleting faculty profile.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        }
